...
export function determineFrustumSet( tile, renderer ) {
	...
	if ( ! tile.__contentEmpty ) {
		...
		// console.log('tile.depth: ', tile.__depth);
...
export function skipTraversal( tile, renderer ) {
	...
	if ( tile.__isLeaf ) {
		...
		// console.log('leaf depth：', tile.__depth);
	...
	// console.log('tile.__error: ', tile.__error);
	...
	// console.log('tile: ', tile.content.uri);
	// console.log('tile: ', tile);
	// console.log('allChildrenHaveContent: ', allChildrenHaveContent);
	// console.log('childrenWereVisible: ', childrenWereVisible);
	...
	// load in.
	// if (refine === 'REPLACE' &&  meetsSSE && ! allChildrenHaveContent && ! childrenWereVisible ) {
	if (refine === 'REPLACE' && ! allChildrenHaveContent && ! childrenWereVisible ) {
